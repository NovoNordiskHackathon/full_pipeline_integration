...
# Import updated pipeline modules from backend directory
from backend.json_struct_protocol import run_hierarchy as process_protocol  # type: ignore
from backend.json_struct_ecrf import run_hierarchy as process_ecrf  # type: ignore
...
def run_ptd_generation():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            cmd = [
                sys.executable,
                os.path.join(backend_dir, "PTD_Gen", "generate_ptd.py"),
                "--protocol",
                protocol_file,
                "--ecrf",
                ecrf_file,
