...
from simpletext_extract import extract_text_and_tables_from_pdf
...
def process_uploaded_files():
    ...
    try:
        ...
        extract_text_and_tables_from_pdf(protocol_pdf_path, protocol_zip_path)
        logger.info(f"✓ Protocol extracted to: {protocol_zip_path}")

        logger.info(f"Extracting text from CRF PDF...")
        extract_text_and_tables_from_pdf(crf_pdf_path, crf_zip_path)
